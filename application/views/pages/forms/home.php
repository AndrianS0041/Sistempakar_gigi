    ...
    <div class="container">
      <div class="row slider-text align-items-center" data-scrollax-parent="true">
        <div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
          ...
          <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="#" class="btn btn-primary px-4 py-3">Lebih Lanjut</a></p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row justify-content-center mb-5 pb-5">
      <div class="col-md-7 text-center heading-section ftco-animate">
        ...
        <p>A small river named Duden flows by their place and supplies it with the necessary regelialia. (Sebagai judul pelayanan)</p>
      </div>
      <div class="row">
        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-block text-center">
            ...
            <div class="media-body p-2 mt-3">
              <h3 class="heading">Pemutih gigi</h3>
              <p>Bahkan Pointing yang sangat kuat tidak memiliki kendali tentang teks-teks buta itu hampir tidak ortografis.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-block text-center">
            ...
            <div class="media-body p-2 mt-3">
              <h3 class="heading">Pembersihan Gigi</h3>
              <p>Bahkan Pointing yang sangat kuat tidak memiliki kendali tentang teks-teks buta itu hampir tidak ortografis.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-block text-center">
            ...
            <div class="media-body p-2 mt-3">
              <h3 class="heading">Kurung Berkualitas</h3>
              <p>Bahkan Pointing yang sangat kuat tidak memiliki kendali tentang teks-teks buta itu hampir tidak ortografis.</p>
            </div>
          </div>
        </div>
        <div class="col-md-3 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services d-block text-center">
            ...
            <div class="media-body p-2 mt-3">
              <h3 class="heading">Anestesi Modern</h3>
              <p>Bahkan Pointing yang sangat kuat tidak memiliki kendali tentang teks-teks buta itu hampir tidak ortografis.</p>
            </div>
</section>
</section>
